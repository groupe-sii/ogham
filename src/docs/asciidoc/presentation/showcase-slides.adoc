...
:delay: 1500
include::{doc-base-dir}/presentation/delay.adoc[]
...
[source, java, role="fragment irrelevant-lines:2"]
----
@GreenMailServer
...
----
@Test
public void userShouldReceiveConfirmationEmail(GreenMail greenMail) {
...
----
@Test
public void userShouldReceiveConfirmationCode(SmppServerSimulator<SubmitSm> smppServer) {
