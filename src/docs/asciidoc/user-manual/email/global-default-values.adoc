...
{standard-email-samples-sourcedir-url}/OverrideDefaultSenderSample.java?ts=4[Source code of the sample].
...
----
include::{ogham-all-testsourcedir}/fr/sii/ogham/it/email/EmailPropertiesTest.java[]
----
<1> Define 3 `to` recipients
<2> Define 2 `cc` recipients
<3> Define a single `bcc` recipient

{ogham-all-testsourcedir-url}/fr/sii/ogham/it/email/EmailPropertiesTest.java?ts=4[Source code of the sample].
