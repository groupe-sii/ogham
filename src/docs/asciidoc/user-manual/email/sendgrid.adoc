...
[role=tab]
image:{images-dir}/icons/java-logo.png[width=16,height=30] Java (SendGrid)
...
[role=tab]
image:{images-dir}/icons/properties.png[width=37,height=30] Properties (SendGrid)
...
[role=tab]
image:{images-dir}/icons/java-logo.png[width=16,height=30] Java (JavaMail)
...
[role=tab]
image:{images-dir}/icons/properties.png[width=37,height=30] Properties (JavaMail)
