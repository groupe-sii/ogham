...
This sample shows how to send a basic email through GMail. {standard-email-samples-sourcedir-url}/gmail/GmailSSLBasicSample.java?ts=4[The sample is available here].
...
----
<1> Use the standard builder to configure and instantiate the MessagingService
...
{standard-email-samples-sourcedir-url}/gmail/GmailSSLBasicSample.java[Source code of the sample]
