...
image:https://github.com/groupe-sii/ogham/workflows/Build/badge.svg?branch={badges-branch}["Build Status", link="https://github.com/groupe-sii/ogham/actions?query=workflow%3ABuild"]
...
image::{site-version-url}/presentation/showcase.png[Showcase, link={site-version-url}/showcase-video.html]
...
[%autowidth.stretch]
|===
| **v{ogham-version}** (Latest release)                   | **v{ogham-dev-version}** (Current development)
| {site-version-url}[site]                                | {site-dev-version-url}[site] 
| {sourcedir-url}[code]                                   | {sourcedir-dev-url}[code]
| {site-version-url}/presentation/showcase.html[showcase] | {site-dev-version-url}/presentation/showcase.html[showcase]
|=== 
