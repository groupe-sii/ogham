...
====
image:{images-dir}/icons/email.png[Email,width=100,height=100]
...
====
image:{images-dir}/icons/sms.png[Email,width=100,height=100]
...
====
image:{images-dir}/icons/spring-boot.png[Email,width=100,height=100]

Spring
====

[role="feature feature-customizable"]
====
image:{images-dir}/icons/email.png[Email,width=100,height=100]
