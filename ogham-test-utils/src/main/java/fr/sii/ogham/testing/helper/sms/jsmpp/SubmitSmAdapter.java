...
import fr.sii.ogham.testing.helper.sms.bean.Command;
import fr.sii.ogham.testing.helper.sms.bean.OptionalParameter;
import fr.sii.ogham.testing.helper.sms.bean.SimpleAddress;
import fr.sii.ogham.testing.helper.sms.bean.SimpleCommand;
