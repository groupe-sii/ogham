					...
					<tr>
						<td bgcolor="#ffffff" id="td_2a02_2">
							<table border="0" cellpadding="0" cellspacing="0" width="100%">
								...
								<tr>
									<td id="td_2a02_4" class="value">${value}</td>
								</tr>
								<tr>
									<td>
										<table border="0" cellpadding="0" cellspacing="0" width="100%">
											<tr>
												<td width="260" valign="top">
													<table border="0" cellpadding="0" cellspacing="0" width="100%">
														<tr>
															<td>
																<img src="classpath:/resources/images/left.gif" alt="" width="100%" height="140" />
															</td>
														</tr>
														<tr>
															<td class="paragraph">
												...
												<td width="260" valign="top">
													<table border="0" cellpadding="0" cellspacing="0" width="100%">
														<tr>
															<td>
																<img src="classpath:/resources/images/right1.gif" alt="" width="100%" height="140" />
															</td>
														</tr>
														<tr>
															<td class="paragraph">
											...
											<tr>
												<td class="link">
													<a href="http://www.twitter.com/" class="white">
														<img src="classpath:/resources/images/tw.gif" alt="Twitter" width="38" height="38" border="0" />
													</a>
												</td>
												<td id="td_2a02_11" width="20">&nbsp;</td>
												<td class="link">
													<a href="http://www.twitter.com/" class="white">
														<img src="classpath:/resources/images/fb.gif" alt="Facebook" width="38" height="38" border="0" />
													</a>
												</td>
											</tr>
										</table>
