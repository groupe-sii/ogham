...
public class HtmlAndTextTemplateSample {
	...
	public static void main(String[] args) throws MessagingException {
		...
		// or using fluent API
		service.send(new Email().subject("subject").content(new MultiTemplateContent("classpath:/template/freemarker/simple", new SimpleBean("foo", 42))).to("<recipient address>"));
	}
