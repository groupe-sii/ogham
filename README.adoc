...
<2> Register the custom properties
<3> Create a MessagingService instance
<4> Send an email with an explicit subject. The sender address is automatically set using `ogham.email.from` property
...
<title>Demystifying Email Design</title>                                                                    <!--1-->
<meta name="viewport" content="width=device-width, initial-scale=1.0" />
<link href="css/layout.css" rel="stylesheet" />                                                                <!--2-->
<link href="css/custom.css" rel="stylesheet" />                                                                <!--3-->
</head>
<body>
    <div class="main-content">
        <div class="header">
            <img src="images/h1.gif" alt="Creating Email Magic" />                                            <!--4-->
        </div>
        <div class="content">
            <span th:text="${name}">name</span>
            <p th:text="${value}">value</p>
            <div class="left">
                <img src="images/left.gif" data-inline="base64" />                                            <!--5-->
                <p class="text">
        ...
        <div class="footer">
            <div class="sender-info">
                ...
                <a href="#" class="white">Unsubscribe</a> to this newsletter instantly
            </div>
            <div class="social">
                <a href="http://www.twitter.com/" class="white">
                    <img src="images/tw.gif" alt="Twitter" />                                                <!--7-->
                </a>
                <a href="http://www.twitter.com/" class="white">
                    <img src="images/fb.gif" alt="Facebook" data-inline="skip" />                            <!--8-->
                </a>
            </div>
        </div>
    </div>
...
[NOTE]
====
The call order between `text()` and `html()` doesn't matter.
====
...
The property is `ogham.email.subject`.
...
[role=tab]
image:src/docs/resources/images/icons/java-logo.png[width=16,height=30] Java (SendGrid)
...
[role=tab]
image:src/docs/resources/images/icons/properties.png[width=37,height=30] Properties (SendGrid)

[source, python]
----
# ogham additional properties
ogham.email.sengrid.api-key=<your sendgrid API key>                    # <1>
ogham.email.from=<sender email address>                                # <2>
...
[role=tab]
image:src/docs/resources/images/icons/java-logo.png[width=16,height=30] Java (JavaMail)
...
[role=tab]
image:src/docs/resources/images/icons/properties.png[width=37,height=30] Properties (JavaMail)
...
# ogham additional properties
ogham.email.from=<sender email address>                                    # <3>
...
https://github.com/groupe-sii/ogham/tree/v2.0.0/sample-spring-usage/src/main/resources/email/mixed.txt.ftl?ts={tabsize}[Source code of the text template]
