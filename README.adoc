...
image:https://github.com/groupe-sii/ogham/workflows/Build/badge.svg?branch=v3.0.x["Build Status", link="https://github.com/groupe-sii/ogham/actions?query=workflow%3ABuild"]
...
image::https://groupe-sii.github.io/ogham/v3.0.1-SNAPSHOT/presentation/showcase.png[Showcase, link=https://groupe-sii.github.io/ogham/v3.0.1-SNAPSHOT/showcase-video.html]
...
| image:https://img.shields.io/static/v1?label=This%20version&message=v3.0.1-SNAPSHOT[This version, link="https://groupe-sii.github.io/ogham/v3.0.1-SNAPSHOT"]
...
| https://groupe-sii.github.io/ogham/v3.0.1-SNAPSHOT[site]
...
| https://github.com/groupe-sii/ogham/tree/v3.0.x[code]
...
| https://groupe-sii.github.io/ogham/v3.0.1-SNAPSHOT/presentation/showcase.html[showcase]
...
https://github.com/groupe-sii/ogham/tree/v3.0.x/sample-standard-usage/pom.xml?ts=2[View code of an example pom.xml]
...
...
dependencies {
    implementation 'fr.sii.ogham:ogham-all:3.0.1-SNAPSHOT'
}
----
...
dependencies {
    implementation 'fr.sii.ogham:ogham-spring-boot-starter-all:3.0.1-SNAPSHOT'
...
}
----
...
dependencies {
    implementation 'fr.sii.ogham:ogham-spring-boot-starter-all:3.0.1-SNAPSHOT'   // <1>
...
See how to https://groupe-sii.github.io/ogham/v3.0.1-SNAPSHOT/user-manual.html#select-features-standalone[select features].
...
take a look at https://groupe-sii.github.io/ogham/v3.0.1-SNAPSHOT/user-manual.html#freemarker[FreeMarker section].
====
...
[NOTE]
====
The samples are available in the https://github.com/groupe-sii/ogham/tree/v3.0.x/sample-standard-usage[sample-standard-usage sub-project].

All samples shown bellow are using SMTP for sending email. 
See https://groupe-sii.github.io/ogham/v3.0.1-SNAPSHOT/user-manual.html#sendgrid[Sending email through SendGrid] 
...
https://github.com/groupe-sii/ogham/tree/v3.0.x/sample-standard-usage/src/main/java/fr/sii/ogham/sample/standard/email/BasicSample.java?ts=2[Source code of the sample].
...
Properties are directly provided in the code. You can instead https://groupe-sii.github.io/ogham/v3.0.1-SNAPSHOT/user-manual.html#properties-handling[use a configuration file].
...
https://github.com/groupe-sii/ogham/tree/v3.0.x/sample-standard-usage/src/main/java/fr/sii/ogham/sample/standard/email/HtmlTemplateSample.java?ts=2[Source code of the sample].
...
https://github.com/groupe-sii/ogham/tree/v3.0.x/sample-standard-usage/src/main/resources/template/thymeleaf/simple.html?ts=2[Source code of the HTML template]
...
classpath is used by default. See https://groupe-sii.github.io/ogham/v3.0.1-SNAPSHOT/user-manual.html#resource-resolution[Resource resolution section] for more information.
...
https://github.com/groupe-sii/ogham/tree/v3.0.x/sample-standard-usage/src/main/java/fr/sii/ogham/sample/standard/email/HtmlTemplateWithSubjectSample.java?ts=2[Source code of the sample]
...
https://github.com/groupe-sii/ogham/tree/v3.0.x/sample-standard-usage/src/main/resources/template/thymeleaf/simpleWithSubject.html?ts=2[Source code of the HTML template]
...
https://github.com/groupe-sii/ogham/tree/v3.0.x/sample-standard-usage/src/main/java/fr/sii/ogham/sample/standard/email/TextTemplateWithSubjectSample.java?ts=2[Source code of the sample]
...
https://github.com/groupe-sii/ogham/tree/v3.0.x/sample-standard-usage/src/main/resources/template/freemarker/simpleWithSubject.txt.ftl?ts=2[Source code of the text template]
...
https://github.com/groupe-sii/ogham/tree/v3.0.x/sample-standard-usage/src/main/java/fr/sii/ogham/sample/standard/email/HtmlWithImagesAndCssTemplateSample.java?ts=2[Source code of the sample]
...
https://github.com/groupe-sii/ogham/tree/v3.0.x/sample-standard-usage/src/main/resources/template/withImagesAndCss/resources.html?ts=2[Source code of the HTML template]
...
https://github.com/groupe-sii/ogham/tree/v3.0.x/sample-standard-usage/src/main/java/fr/sii/ogham/sample/standard/email/HtmlAndTextSample.java?ts=2[Source code of the sample]
...
https://github.com/groupe-sii/ogham/tree/v3.0.x/sample-standard-usage/src/main/java/fr/sii/ogham/sample/standard/email/HtmlAndTextTemplateSample.java?ts=2[Source code of the sample]
...
https://github.com/groupe-sii/ogham/tree/v3.0.x/sample-standard-usage/src/main/resources/template/thymeleaf/simple.txt?ts=2[Source code of the text template]
...
https://github.com/groupe-sii/ogham/tree/v3.0.x/sample-standard-usage/src/main/java/fr/sii/ogham/sample/standard/email/HtmlAndTextMixedTemplateEnginesSample.java?ts=2[Source code of the sample]
...
https://github.com/groupe-sii/ogham/tree/v3.0.x/sample-standard-usage/src/main/resources/template/mixed/simple.txt.ftl?ts=2[Source code of the text template]
...
https://github.com/groupe-sii/ogham/tree/v3.0.x/sample-standard-usage/src/main/resources/template/mixed/simple.html?ts=2[Source code of the HTML template]
...
https://github.com/groupe-sii/ogham/tree/v3.0.x/sample-standard-usage/src/main/java/fr/sii/ogham/sample/standard/email/WithAttachmentSample.java?ts=2[Source code of the sample]
...
(see https://groupe-sii.github.io/ogham/v3.0.1-SNAPSHOT/user-manual.html#resource-resolution[ resource resolution section]). In case you are using a file, 
...
See user guide to read about https://groupe-sii.github.io/ogham/v3.0.1-SNAPSHOT/user-manual.html#email-usage[the many other features]. 
...
in https://groupe-sii.github.io/ogham/v3.0.1-SNAPSHOT/user-manual.html#advanced-smpp-configuration[advanced configuration].

See https://groupe-sii.github.io/ogham/v3.0.1-SNAPSHOT/user-manual.html#ovh[Sending SMS through OVH] to know how to send SMS using OVH HTTP API.
====
...
https://github.com/groupe-sii/ogham/tree/v3.0.x/sample-standard-usage/src/main/java/fr/sii/ogham/sample/standard/sms/BasicSample.java?ts=2[Source code of the sample].
...
https://github.com/groupe-sii/ogham/tree/v3.0.x/sample-standard-usage/src/main/java/fr/sii/ogham/sample/standard/sms/TemplateSample.java?ts=2[Source code of the sample].
...
https://github.com/groupe-sii/ogham/tree/v3.0.x/sample-standard-usage/src/main/resources/template/thymeleaf/simple.txt?ts=2[Source code of the template]
...
https://github.com/groupe-sii/ogham/tree/v3.0.x/sample-standard-usage/src/main/java/fr/sii/ogham/sample/standard/sms/LongMessageSample.java?ts=2[Source code of the sample].
...
Ogham provides https://groupe-sii.github.io/ogham/v3.0.1-SNAPSHOT/user-manual.html#sms-usage[many other features]. 
...
----
dependencies {
    testImplementation 'fr.sii.ogham:ogham-test-utils:3.0.1-SNAPSHOT'
}
----
...
====
You can 
https://groupe-sii.github.io/ogham/v3.0.1-SNAPSHOT/user-manual.html#testing-tools-eclipse-static-imports[configure Eclipse]
...
https://github.com/groupe-sii/ogham/tree/v3.0.x/sample-standard-usage/src/test/java/fr/sii/ogham/sample/test/EmailTestSample.java?ts=2[Source code of the sample].
...
https://github.com/groupe-sii/ogham/tree/v3.0.x/sample-standard-usage/src/test/java/fr/sii/ogham/sample/test/SmsTestSample.java?ts=2[Source code of the sample].
...
* https://groupe-sii.github.io/ogham/v3.0.1-SNAPSHOT/user-manual.html#testing-email[Email assertions and tools].
* https://groupe-sii.github.io/ogham/v3.0.1-SNAPSHOT/user-manual.html#testing-sms[SMS assertions and tools].
* https://groupe-sii.github.io/ogham/v3.0.1-SNAPSHOT/user-manual.html#random-ports[Use random ports to parallelize tests].


== Advanced configuration

https://groupe-sii.github.io/ogham/v3.0.1-SNAPSHOT/user-manual.html#section-advanced-configuration[See advanced configuration in full documentation]

== Extend

https://groupe-sii.github.io/ogham/v3.0.1-SNAPSHOT/user-manual.html#section-extend[See how to extend in full documentation]

== Tips

https://groupe-sii.github.io/ogham/v3.0.1-SNAPSHOT/user-manual.html#section-tips[See tips in full documentation]
