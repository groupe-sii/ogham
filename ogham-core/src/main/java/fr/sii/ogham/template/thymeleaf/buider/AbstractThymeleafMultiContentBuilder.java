...
import fr.sii.ogham.template.freemarker.builder.VariantWithExt;

public abstract class AbstractThymeleafMultiContentBuilder<MYSELF extends AbstractThymeleafMultiContentBuilder<MYSELF, P>, P> extends AbstractThymeleafBuilder<MYSELF, P> implements VariantBuilder<MYSELF> {
