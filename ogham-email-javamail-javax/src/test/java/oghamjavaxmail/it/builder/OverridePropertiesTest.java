package oghamjavaxmail.it.builder;
...
import fr.sii.ogham.email.builder.javaxmail.OverrideJavaxMailResolver;
...
public class OverridePropertiesTest {
	...
	public void values() {
		...
		OverrideJavaxMailResolver props = new OverrideJavaxMailResolver(defaultResolver, converter, hosts, ports);
	...
	public void valuesWithEmptyProps() {
		...
		OverrideJavaxMailResolver props = new OverrideJavaxMailResolver(emptyResolver, converter, hosts, ports);
		assertThat(props.containsProperty("mail.smtp.host"), is(true));
		assertThat(props.getProperty("mail.smtp.host"), is("localhost"));
		assertThat(props.containsProperty("mail.smtp.port"), is(true));
		assertThat(props.getProperty("mail.smtp.port"), is("1000"));
