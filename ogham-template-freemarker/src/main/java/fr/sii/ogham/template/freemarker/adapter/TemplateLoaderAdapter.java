...
/**
 * Adapter that provides the FreeMarker specific {@link TemplateLoader} from the
 * general {@link ResourceResolver}.
 * 
...
public interface TemplateLoaderAdapter {
	 ...
	 * @throws ResolverAdapterException
	 ...
	 */
	TemplateLoader adapt(ResourceResolver resolver) throws ResolverAdapterException;
